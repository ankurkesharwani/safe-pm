...
def attach_subparser(program_subparser):
    ...
    create_parser.add_argument("--account", required=True, help="Account name")
    ...
    password_group.add_argument("--password", action="store_true", help="Password to use")
    ...
    view_parser.add_argument("--account", required=True, help="Account name")
    ...
    copy_parser.add_argument("--account", required=True, help="Account name")
    ...
    update_parser.add_argument("--account", required=True, help="Account name")
    password_group = update_parser.add_mutually_exclusive_group(required=True)
    password_group.add_argument("--password", action="store_true", help="Use own password")
    password_group.add_argument("--auto-gen-password", action="store_true", help="Auto-generate password")
    ...
    history_parser.add_argument("--account", required=True, help="Account name")
...
def execute(args):
    ...
    if args.command == "list":
        ...
        account_manager.delete_account(args.db, args.store, args.account)
    elif args.command == "history":
        account_manager.account_history(args.db, args.store, args.account)
    else:
        sys.exit(2)
